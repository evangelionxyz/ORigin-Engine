...
void OpenGLShader::SetFloat(const std::string &name, f32 *values, i32 count)
{
    SetUniformFloat(name, values, count);
}
...
void OpenGLShader::SetInt(const std::string &name, i32 *values, const i32 count)
{
    SetUniformInt(name, values, count);
}
...
void OpenGLShader::SetUniformFloat(const std::string &name, f32 *values, i32 count)
{
...
void OpenGLShader::SetUniformInt(const std::string &name, i32 *values, const i32 count)
{
