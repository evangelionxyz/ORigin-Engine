...
#pragma region theme_init
        ...
        colors[ImGuiCol_FrameBgActive] = ImVec4(0.58f, 0.58f, 0.58f, 1.00f);
        ...
        colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.74f, 0.51f, 0.00f, 1.00f);
        colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.74f, 0.51f, 0.00f, 1.00f);
        colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.99f, 0.69f, 0.00f, 1.00f);
        colors[ImGuiCol_CheckMark] = ImVec4(0.90f, 0.90f, 0.90f, 1.00f);
        colors[ImGuiCol_SliderGrab] = ImVec4(0.74f, 0.51f, 0.00f, 1.00f);
        colors[ImGuiCol_SliderGrabActive] = ImVec4(0.99f, 0.69f, 0.00f, 1.00f);
        colors[ImGuiCol_Button] = ImVec4(0.00f, 0.18f, 0.25f, 1.00f);
        colors[ImGuiCol_ButtonHovered] = ImVec4(0.05f, 0.38f, 0.52f, 1.00f);
        colors[ImGuiCol_ButtonActive] = ImVec4(0.05f, 0.38f, 0.52f, 1.00f);
        colors[ImGuiCol_Header] = ImVec4(0.03f, 0.26f, 0.37f, 1.00f);
        colors[ImGuiCol_HeaderHovered] = ImVec4(0.03f, 0.35f, 0.49f, 1.00f);
        colors[ImGuiCol_HeaderActive] = ImVec4(0.03f, 0.35f, 0.49f, 1.00f);
        ...
        colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.66f, 0.46f, 0.00f, 1.00f);
        colors[ImGuiCol_ResizeGripActive] = ImVec4(0.99f, 0.69f, 0.00f, 1.00f);
        colors[ImGuiCol_TabHovered] = ImVec4(0.29f, 0.29f, 0.29f, 1.00f);
        colors[ImGuiCol_Tab] = ImVec4(0.23f, 0.23f, 0.23f, 1.00f);
        colors[ImGuiCol_TabSelected] = ImVec4(0.38f, 0.25f, 0.00f, 1.00f);
        colors[ImGuiCol_TabSelectedOverline] = ImVec4(1.00f, 0.67f, 0.00f, 1.00f);
        colors[ImGuiCol_TabDimmed] = ImVec4(0.38f, 0.25f, 0.00f, 1.00f);
        colors[ImGuiCol_TabDimmedSelected] = ImVec4(0.15f, 0.15f, 0.15f, 1.00f);
        colors[ImGuiCol_TabDimmedSelectedOverline] = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
        colors[ImGuiCol_DockingPreview] = ImVec4(0.61f, 0.43f, 0.07f, 1.00f);
