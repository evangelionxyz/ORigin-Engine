...
#pragma region theme_init
		...
		colors[ImGuiCol_SliderGrab] = ImVec4(0.36f, 0.0f, 0.0f, 1.00f);
		...
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.36f, 0.0f, 0.0f, 1.00f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(1.0f, 0.0f, 0.0f, 1.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.24f, 0.24f, 0.24f, 1.00f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.29f, 0.29f, 0.29f, 1.00f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(1.0f, 0.0f, 0.0f, 1.00f);
		colors[ImGuiCol_Tab] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
		colors[ImGuiCol_TabHovered] = ImVec4(0.29f, 0.29f, 0.29f, 1.00f);
		colors[ImGuiCol_TabActive] = ImVec4(0.45f, 0.45f, 0.45f, 1.00f);
		colors[ImGuiCol_TabUnfocused] = ImVec4(0.15f, 0.15f, 0.15f, 1.00f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
		colors[ImGuiCol_DockingPreview] = ImVec4(0.29f, 0.29f, 0.29f, 1.00f);
		...
		colors[ImGuiCol_TableRowBgAlt] = ImVec4(0.24f, 0.24f, 0.24f, 1.00f);
