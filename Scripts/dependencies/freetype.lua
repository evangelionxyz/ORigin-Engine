...
project "FreeType"
    ...
    files {
        ...
        "%{THIRD_PARTY_DIR}/MSDFATLASGEN/msdfgen/freetype/include/freetype/**.h",
        "%{THIRD_PARTY_DIR}/MSDFATLASGEN/msdfgen/freetype/include/freetype/config/**.h",
        "%{THIRD_PARTY_DIR}/MSDFATLASGEN/msdfgen/freetype/include/freetype/internal/**.h",
    ...
    includedirs { "%{THIRD_PARTY_DIR}/MSDFATLASGEN/msdfgen/freetype/include"}
